...
def training_joint(target_sequence, summary_embedding, tokenizer, gd, fn_generate):
...
if __name__ == "__main__":
    ...
    summary_embedding_1 = training_joint(target_sequence, input_embedding, tokenizer, gd, fn_generate_full)
    end_time = time.time()
