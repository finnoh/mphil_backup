...
For a given target sequence, we find the input-embedding that maximizes the likelihood to generate this target sequence with a unidirectional LLM (e.g. GPT, @radford2018improving). We call this input embedding, "summary embedding" of the target sequence.
